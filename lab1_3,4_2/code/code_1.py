...
#     if check_digit_1(side_1) and check_zero_1(side_1):
#         side_1 = float(side_1)
#         break
#
# #Внутри цикла while с условием True вводим с клавиатуры значения стороны и устраиваем проверкку на символы и на 0. Если обе проверки пройдены преобразовываем переменную из str в float
...
#     if check_digit_1(side_2) and check_zero_1(side_2):
#         side_2 = float(side_2)
#         break
#
# #Внутри цикла while с условием True вводим с клавиатуры значения стороны и устраиваем проверкку на символы и на 0. Если обе проверки пройдены преобразовываем переменную из str в float
...
#     if check_digit_1(side_3) and check_zero_1(side_3):
#         side_3 = float(side_3)
#         break
...
# else:
#     print(f"Площадь треугольника: {get_square_1(side_1, side_2, side_3)}\nТип треугольника: {get_type_1(side_1, side_2, side_3)}")
